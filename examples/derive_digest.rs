...
fn main() -> anyhow::Result<()> {
    let schema_id = SchemaId::from_str(
        "lsc1rsj2sjurqllj4859jgvdwerkjvj4tdfpf7xpc42jyjmzp793jjrqu3an2p",
    )?;
    let payload_hash = PayloadHash::from_str(
        "lph1he42sgwn7mp5qhkuklxahn6pncqpr83jr3hmgezj9qw6l42ezwkqw5zknm",
    )?;
    let submitter = <S as Spec>::Address::from_str(
